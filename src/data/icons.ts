...
export const icons: Icon[] = [
  ...
  },
  {
    name: 'at-sign',
    category: 'communication',
    tags: ['at', 'mention', 'email'],
    svg: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"/><path d="M16 8v5a3 3 0 0 0 6 0v-1a10 10 0 1 0-4 8"/></svg>'
  },
  {
    name: 'inbox',
    category: 'communication',
    tags: ['inbox', 'mail', 'receive'],
  ...
  },
  {
    name: 'paperclip',
    category: 'files',
    tags: ['paperclip', 'attachment', 'attach'],
  ...
  },
  {
    ...
    svg: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15.54 8.46a5 5 0 0 1 0 7.07"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14"/></svg>'
  },
  {
    name: 'volume-x',
    category: 'media',
    tags: ['volume', 'mute', 'silence', 'off'],
  ...
  },
  {
    name: 'mic',
    category: 'media',
    tags: ['mic', 'microphone', 'record', 'audio'],
  ...
  },
  {
    name: 'shield',
    category: 'interface',
    tags: ['shield', 'security', 'protect', 'safe'],
    svg: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"/></svg>'
  },
  {
    name: 'key',
    category: 'interface',
    tags: ['key', 'password', 'access', 'auth'],
  ...
  // Status
  {
    name: 'alert-circle',
    category: 'status',
    tags: ['alert', 'error', 'warning', 'danger'],
  ...
  },
  {
    name: 'loader',
    category: 'status',
    tags: ['loader', 'loading', 'spinner', 'process'],
  ...
  // Commerce
  {
    name: 'shopping-cart',
    category: 'commerce',
    tags: ['cart', 'shopping', 'buy', 'ecommerce'],
  ...
  },
  {
    name: 'package',
    category: 'commerce',
    tags: ['package', 'box', 'product', 'delivery'],
  ...
  },
  {
    name: 'trending-down',
    category: 'charts',
    tags: ['trending', 'down', 'decrease', 'loss'],
  ...
  },
  {
    name: 'activity',
    category: 'charts',
    tags: ['activity', 'pulse', 'monitor', 'health'],
  ...
  },
  {
    name: 'list',
    category: 'layout',
    tags: ['list', 'rows', 'items'],
    svg: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="8" x2="21" y1="6" y2="6"/><line x1="8" x2="21" y1="12" y2="12"/><line x1="8" x2="21" y1="18" y2="18"/><line x1="3" x2="3.01" y1="6" y2="6"/><line x1="3" x2="3.01" y1="12" y2="12"/><line x1="3" x2="3.01" y1="18" y2="18"/></svg>'
  },
  {
    name: 'sidebar',
    category: 'layout',
    tags: ['sidebar', 'panel', 'menu'],
    svg: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M9 3v18"/></svg>'
  },
  {
    name: 'maximize',
    category: 'layout',
  ...
  },
  {
    ...
    svg: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8 3v3a2 2 0 0 1-2 2H3"/><path d="M21 8h-3a2 2 0 0 1-2-2V3"/><path d="M3 16h3a2 2 0 0 1 2 2v3"/><path d="M16 21v-3a2 2 0 0 1 2-2h3"/></svg>'
  },
  {
    name: 'columns',
    category: 'layout',
    tags: ['columns', 'layout', 'split'],
    svg: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M12 3v18"/></svg>'
  },
  ...
  },
  {
    name: 'server',
    category: 'development',
    tags: ['server', 'hosting', 'cloud', 'host'],
    svg: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="8" x="2" y="2" rx="2" ry="2"/><rect width="20" height="8" x="2" y="14" rx="2" ry="2"/><line x1="6" x2="6.01" y1="6" y2="6"/><line x1="6" x2="6.01" y1="18" y2="18"/></svg>'
  },
  {
    name: 'cloud',
    category: 'development',
    tags: ['cloud', 'hosting', 'storage', 'saas'],
  ...
  },
  {
    name: 'package',
    category: 'development',
    tags: ['package', 'module', 'library', 'dependency'],
    svg: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m7.5 4.27 9 5.15"/><path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"/><path d="m3.3 7 8.7 5 8.7-5"/><path d="M12 22V12"/></svg>'
  },
  {
    name: 'zap',
    category: 'development',
    tags: ['zap', 'lightning', 'fast', 'quick', 'energy'],
  ...
  },
  {
    name: 'thermometer',
    category: 'weather',
    tags: ['thermometer', 'temperature', 'hot', 'cold'],
  ...
  },
  {
    name: 'compass',
    category: 'miscellaneous',
    tags: ['compass', 'direction', 'navigation', 'explore'],
  ...
  },
  {
    ...
    svg: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h.01"/><path d="M2 8.82a15 15 0 0 1 20 0"/><path d="M5 12.859a10 10 0 0 1 14 0"/><path d="M8.5 16.429a5 5 0 0 1 7 0"/></svg>'
  },
  {
    name: 'battery',
    category: 'miscellaneous',
  ...
  },
  {
    name: 'link',
    category: 'miscellaneous',
    tags: ['link', 'url', 'chain', 'href'],
    svg: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>'
  },
  {
    name: 'hash',
    category: 'miscellaneous',
    tags: ['hash', 'number', 'pound', 'hashtag'],
